...
# Initialize go and yp distances
dist_go = 0
dist_yp = 0
    ...
    if(perceived_top_dist1 and perceived_bot_dist1 and perceived_top_dist2 and perceived_bot_dist2 != 0):
        ...
        if dist_yp != 0:
            try:
                ...
                print(f"The yp distance is {dist_yp}")
        ...
        if dist_go != 0:
            try:
                ...
                print(f"The go distance is {dist_go}")
    ...
    for contour in contours:
        ...
        if ((area > min_area) and (area < max_area)):
            ...
            if combo == 'go':
                ...
                #print(f"Centers2 is {centers2} and distance is {dist_go}")
                #print(prev_x2)
                #print(prev_y2)
                ...
                #print(f"Centers1 is {centers1} and distance are {dist_yp}")
                #print(prev_x1)
                #print(prev_y1)
                #print(f"{combo} countour detected")
            if dist_yp or dist_go != 0:
